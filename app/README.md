...
Uma aplicação web moderna para importação, análise, limpeza e transformação de dados tabulares, inspirada na experiência do Power Query e construída com Python, Flask, Pandas, HTML, CSS e JavaScript.

---

## 📋 Sobre o Projeto

O Data Cleaner Pro foi desenvolvido para simplificar o processo de preparação de dados, permitindo que usuários realizem análises exploratórias, identifiquem problemas de qualidade e executem transformações sem necessidade de programação avançada.
